...
brew "mysql", restart_service: true # REQUIRED - ROR/NODE/DEVOPS/PYTHON/PG Database Dependency for MySQL (Usually used by non-containerized web applications)
brew "mysql-client" # REQUIRED - ROR/NODE/DEVOPS/PYTHON/PG Database Dependency for MySQL
