...
alias teamuitemplate="cd ~/$CURRENT_COMPANY/repos/development-team/k8sapp_ui_template/ && $IDE_PATH ."
alias teamtemplate="cd ~/$CURRENT_COMPANY/repos/development-team/k8sapp_ui_template/ && $IDE_PATH ."
